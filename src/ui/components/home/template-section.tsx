  ...
  return (
    <section className="bg-[#232323] py-16">
      <div className="container mx-auto px-4">
        <h2 className="text-center text-3xl md:text-4xl font-extrabold mb-10 text-[#b4ff3f]">
          {t('title')}
        </h2>
        <div
        ...
        >
          {templates.map((tpl, idx) => (
            <div
              key={idx}
              className="rounded-xl overflow-hidden shadow-lg transition-transform hover:scale-105 bg-[#232323] cursor-pointer"
